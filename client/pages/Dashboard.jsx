                    ...
                    <div className="p-5 flex flex-col gap-4 flex-1">
                      ...
                      {!w.deployed ? (
                        ...
                        <motion.button
                          ...
                          className={`mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition-all ${
                            copied
                              ? "bg-emerald-700/20 text-emerald-400 border border-emerald-600/30"
